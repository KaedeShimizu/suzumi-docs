import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as e}from"./app-423d4233.js";const t={},i=e(`<h1 id="本地版源码" tabindex="-1"><a class="header-anchor" href="#本地版源码" aria-hidden="true">#</a> 本地版源码</h1><p>本着开源的原则，我把本地版的源码放在这里，不过本地版不涉及关键词查询之类的东西，可以理解为就是一个纯粹的随机涩图查询器。</p><p>当然，即便是本地版，我也使用了<code>FastAPI</code>进行开发，从而更好地模拟随机涩图的API调用效果，下面是本地版的目录结构：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>KSA_Local
|-Images_Set
|-|-Arknights
|-GetRankImage.py
|-main.py
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里的<code>Arknights</code>只是一个示例文件夹，代码中也一样；<code>Images_Set</code>顾名思义，就是图片集（图库），也是你调用这个API会查询的文件夹；下面直接上源代码~</p><p>对于<code>main.py</code>，9~16行（高亮部分）可以不写，我这里写上是为了避免直接访问链接报错</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># main.py</span>
...
</code></pre><div class="highlight-lines"><br><br><br><br><br><br><br><br><div class="highlight-line"> </div><div class="highlight-line"> </div><div class="highlight-line"> </div><div class="highlight-line"> </div><div class="highlight-line"> </div><div class="highlight-line"> </div><div class="highlight-line"> </div><div class="highlight-line"> </div><br><br><br><br><br><br><br><br><br><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于<code>GetRankImage.py</code>，如果需要的话可以把它和<code>main.py</code>合并为一个文件，我分文件编写是为了更好地管理目录结构，以及更好地对功能进行拓展。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># GetRankImage.py</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>图片文件夹中的图片没有名称格式要求，因为是完全随机的，代码会自动读取所有的图片然后随机一个出来。</p>`,10),p=[i];function o(c,l){return s(),a("div",null,p)}const r=n(t,[["render",o],["__file","local.html.vue"]]);export{r as default};
