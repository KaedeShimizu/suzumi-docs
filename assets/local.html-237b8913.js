import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as e}from"./app-047ff987.js";const t={},i=e(`<h1 id="本地版源码" tabindex="-1"><a class="header-anchor" href="#本地版源码" aria-hidden="true">#</a> 本地版源码</h1><p>本着开源的原则，我把本地版的源码放在这里，不过本地版不涉及关键词查询之类的东西，可以理解为就是一个纯粹的随机涩图查询器。</p><p>当然，即便是本地版，我也使用了<code>FastAPI</code>进行开发，从而更好地模拟随机涩图的API调用效果，下面是本地版的目录结构：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>KSA_Local
|-Images_Set
|-|-Arknights
|-GetRankImage.py
|-main.py
